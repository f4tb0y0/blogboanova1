...
import { redirect } from 'next/navigation'
  ...
  /**
   * Enables draft mode for the given slug and model.
   *
   * This is a workaround for https://github.com/vercel/next.js/issues/49927
   *
   * @param {string} slug - The slug of the page or post to preview
   * @param {string} model - The model to preview (either 'page' or 'post')
   * @returns {Promise<Response>} - A redirect response to the preview page
   */
